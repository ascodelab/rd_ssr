        ...
        <div class="-mx-8 w-4/12 hidden lg:block">
            ...
            <div class="flex flex-col bg-white max-w-sm px-6 py-4 mx-auto rounded-lg shadow-md">
              <ul class="-mx-4">
                <li class="flex items-center">
                  ...
                  />
                  <p>
                    <a href="#" class="text-gray-700 font-bold mx-1 hover:underline">Alex John</a>
                ...
                <li class="flex items-center mt-6">
                  ...
                  />
                  <p>
                    <a href="#" class="text-gray-700 font-bold mx-1 hover:underline">Jane Doe</a>
                ...
                <li class="flex items-center mt-6">
                  ...
                  />
                  <p>
                    <a href="#" class="text-gray-700 font-bold mx-1 hover:underline">Lisa Way</a>
                    <span class="text-gray-700 text-sm font-light">Created 73 Posts</span>
                  </p>
                </li>
                <li class="flex items-center mt-6">
                  <img
                  ...
                  />
                  <p>
                    <a href="#" class="text-gray-700 font-bold mx-1 hover:underline">Steve Matt</a>
                    <span class="text-gray-700 text-sm font-light">Created 245 Posts</span>
                  </p>
                </li>
                <li class="flex items-center mt-6">
                  <img
                  ...
                  <p>
                    ...
                    <span class="text-gray-700 text-sm font-light">Created 332 Posts</span>
                  </p>
                </li>
              </ul>
            </div>
          ...
          <div class="mt-10 px-8">
            ...
            <div class="flex flex-col bg-white px-8 py-6 max-w-sm mx-auto rounded-lg shadow-md">
              ...
              <div class="mt-4">
                <a href="#" class="text-lg text-gray-700 font-medium hover:underline">
                  Build
                  Your New Idea with Laravel Freamwork.
                </a>
              </div>
