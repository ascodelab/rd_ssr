    ...
    <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g opacity="0.1">
                ...
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="#d47192" />
                <path
              ...
              <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#d47192" opacity="0.1" />
              <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#d47192" opacity="0.1" />
              <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#d47192" opacity="0.1" />
              <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#d47192" opacity="0.1" />
              <path
                ...
                transform="translate(-52 -162.63)" fill="#d47192" opacity="0.1" />
              <path
              ...
              <path
                ...
                transform="translate(-52 -162.63)" opacity="0.1" />
              <circle cx="779.73" cy="238.18" r="99.96" fill="#f5f5f5" />
              <path
              ...
              <path
                ...
                transform="translate(-52 -162.63)" opacity="0.1" />
              <circle cx="550.08" cy="390.01" r="99.96" fill="#f5f5f5" />
              <path
              ...
              <path
                ...
                transform="translate(-52 -162.63)" opacity="0.1" />
              <circle cx="312.85" cy="315.36" r="99.96" fill="#f5f5f5" />
