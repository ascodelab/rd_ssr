    ...
    <div class="flex flex-col justify-between items-center container mx-auto md:flex-row">
      ...
      <div class="flex -mx-2 mt-4 mb-2 md:mt-0 md:mb-0">
        <a
          ...
          class="mx-2 text-rd-theme hover:text-gray-500"
        >
        ...
        <a href="https://www.facebook.com/tyagibhai" class="mx-2 text-rd-theme hover:text-gray-500">
          <svg viewBox="0 0 512 512" class="h-4 w-4 fill-current">
            <path
        ...
        <a href="https://twitter.com/realAnilSharma" class="mx-2 text-rd-theme hover:text-gray-500">
          <svg viewBox="0 0 512 512" class="h-4 w-4 fill-current">
            <path
